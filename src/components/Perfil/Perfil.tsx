...
const Perfil = () => {
    ...
    return (
        ...
        <div className="Perfil">
            ...
            <nav>
                <ul>
                    <Link to={`/Home/Perfil/${idPerfil}/${perfil?.urlPerfil}`}><li>Publicaciones</li></Link>
                    <Link to={`/Home/Perfil/${idPerfil}/${perfil?.urlPerfil}/Fotos`}><li>Fotos</li></Link>
                    <Link to={`/Home/Perfil/${idPerfil}/${perfil?.urlPerfil}/Diarios`}><li>Diarios</li></Link>
                    <Link to={`/Home/Perfil/${idPerfil}/${perfil?.urlPerfil}/D`}><li>Colonia</li></Link>
                </ul>
            </nav>
            <div className='Perfil-contenido'>
                <RoutePerfil />
